...
br Вначале 80-х годов датский программист Бьерн Страуструп который работал в компании Bell Labs разработал С++ как расширение к языку С. Фактически в начале С++ просто дополнял язык С с некоторыми возможностями ООП. Изначально он назывался "Си с классами".
...
br Объектный файл созданный ассемблеров временный файлом хранящий кусок машинного кода.
